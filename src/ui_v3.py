...
# Use the legacy extractor (keeps your exact logic)
import extractfigures as legacy
# import extractfigures as legacy  # <- remove this if present
...
if uploaded_files and st.button("Process PDFs"):
    ...
    # Point legacy extractor to our Streamlit image output directory (the legacy module uses this global)
    ...
    for uf in uploaded_files:
        ...
        # Open PDF and run legacy logic (returns list[dict])
        try:
